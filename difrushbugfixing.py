...
for _,year in enumerate(years[0:6]):
    ...
    # Filter date
        ...
        # print(f'This month, {corrects} buoys were calculated, {errors} buoys gave errors')
